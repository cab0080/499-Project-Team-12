...
<body style="margin: 0; background: #f5f5f5" >
    ...
    <div class="container" style="margin-top: 115px;width: 1000px;">
        <div id="photo_carousel" style="height: 460px;">
          <iframe width="640" height="412" src="https://www.youtube.com/embed/dQw4w9WgXcQ?controls=0&autoplay=1&mute=1" title="YouTube video player" frameborder="0"></iframe>
        </div>
