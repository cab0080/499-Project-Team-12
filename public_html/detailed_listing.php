...
<body style="margin: 0; background: #f5f5f5" >
    ...
    <div class="container" style="margin-top: 115px;width: 1000px;">
        ...
        <div id="listing-summary">
            <div class="row">
                <div class="col">
                    <h1 id="price" style="font-weight: bold;">$100,000</h1>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <ul class="list-inline" style="padding: 0px;">
                        <li class="list-inline-item"><span id="numBed">2</span>&nbsp;bed&nbsp;</li>
                        <li class="list-inline-item"><span id="numBath">2</span>&nbsp;bath&nbsp;</li>
